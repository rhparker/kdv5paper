...
Let $\Phi(x, y; \lambda) = e^{A(\lambda)(x-y)}$ be the evolution of the constant-coefficient equation
\begin{equation}\label{constcoeffZ}
Z'(x) = A(\lambda) Z(x).
\end{equation}
Then the evolution of \cref{vareqlambda} on $\R^\pm$ is given by
