...
\begin{aligned}
Z_i^-(x) = \Phi_i^{s,-}(&x, -X_{i-1}; \lambda) P_i^-(-X_{i-1}, \lambda)^{-1} a_{i-1}^- + \Phi_i^{u,-}(x, 0; \lambda) b_i^- \\
...
Z_i^+(x) = \Phi_i^{u,+}(&x, X_i; \lambda) P_i^+(X_i, \lambda)^{-1} a_i^+ + \Phi_i^{s,+}(x, 0; \lambda) b_i^+ \\
...
&+ P_i^+(X_i; \lambda)\Phi_i^{s,+}(X_i, 0; \lambda) b_i^+ - P_{i+1}^-(-X_i; \lambda)\Phi_i^{u,-}(-X_i, 0; \lambda) b_{i+1}^- \\
...
\[
| P_i^+(X_i; \lambda)\Phi^s(X_i, 0; \lambda) b_i^+ - P_{i+1}^-(-X_i; \lambda) \Phi^u(-X_i, 0; \lambda) b_{i+1}^-| \leq C e^{-\alpha X^*} |b|.
\]
...
\begin{align*}
\langle W_0, &P_i^+(X_i; \lambda)\Phi^s(X_i, 0; \lambda) b_i^+ \rangle
\\
&= \langle [P_i^+(X_i; 0)^{-1}]^* W_0, P_i^+(X_i; 0)\Phi^s(X_i, 0; 0) b_i^+ \rangle + \mathcal{O}(e^{-\alpha X_i} |\lambda||b|) \\
&= \langle W_0, \Phi^s(X_i, 0; 0)  b_i^+ \rangle + \mathcal{O}(e^{-\alpha X_i} |\lambda||b|) = \mathcal{O}(e^{-\alpha X_i} |\lambda||b|)
\end{align*}
...
** stopped here, do we want to modify the b_i^\pm? **
...
\begin{proof}
At $x = 0$, using \cref{Zevolmod}, we have
\begin{equation*}
\begin{aligned}
P_i^-(0; \lambda) &Z_i^-(0) = P_i^-(0; \lambda) \Phi_i^{s,-}(0, -X_{i-1}; \lambda) P_i^-(-X_{i-1}, \lambda)^{-1} a_{i-1}^- + P_i^-(0; \lambda) P^u(\lambda) b_i^- \\
&- P_i^-(0; \lambda) \Phi_i^{c,-}(0, -X_{i-1}; \lambda) P_i^-(-X_{i-1}, \lambda)^{-1} a_{i-1}^c \\
&+ P_i^-(0; \lambda) \int_{-X_{i-1}}^0 \Phi_i^{s,-}(x, y; \lambda) P_i^-(y; \lambda)^{-1} (c_{i-1} G_i^-(y; \lambda) + \lambda^2 d_i \tilde{H}_i^-(y)) \tilde{H}_i^-(y)) dy \\
&+ P_i^-(0; \lambda) \int_{-X_{i-1}}^0 \Phi_i^{c,-}(x, y; \lambda) P_i^-(y; \lambda)^{-1} (c_{i-1} G_i^-(y; \lambda) + \lambda^2 d_i \tilde{H}_i^-(y)) \tilde{H}_i^-(y)) dy  \\ 
P_i^+(0; \lambda) &Z_i^+(0) = P_i^+(0; \lambda) \Phi_i^{u,+}(0, X_i; \lambda) P_i^+(X_i, \lambda)^{-1} a_i^+ + P_i^+(0; \lambda) \Phi_i^{s,+}(0, 0; \lambda) b_i^+ \\
...
\end{aligned}
\end{equation*}
Using the decomposition \cref{TQ0decomp}, $P^+(0; 0) E^s(0) = \C Q'(0) \oplus Y^+$ and $P^-(0; 0) E^u(0) = \C Q'(0) \oplus Y^-$. Let
\begin{align*}
E_1^- = P^-(0; 0)^{-1} \C Q'(0) \in E^u(0), \quad E_1^+ = P^+(0; 0)^{-1} \C Q'(0) \in E^s(0)
\end{align*} 
and decompose $E^u(0)$ and $E^s(0)$ as
\begin{align*}
E^u(0) = E_1^- \oplus E_2^-, E^s(0) = E_1^+ \oplus E_2^+
\end{align*}
Using this, we can write $b_i^\pm$ uniquely as $b_i^\pm = x_i^\pm + y_i^\pm$, where $x_i^\pm \in E_1^\pm$ and $y_i^\pm \in E_2^\pm$. We then rewrite $P_i^\pm(0; \lambda) Z_i^\pm(0)$ as
\begin{equation*}
\begin{aligned}
P_i^-(0; \lambda) &Z_i^-(0) = P_i^-(0; \lambda) \Phi_i^{s,-}(0, -X_{i-1}; \lambda) P_i^-(-X_{i-1}, \lambda)^{-1} a_{i-1}^- + P_i^-(0; \lambda) P^u(\lambda) b_i^- \\
&- P_i^-(0; \lambda) \Phi_i^{c,-}(0, -X_{i-1}; \lambda) P_i^-(-X_{i-1}, \lambda)^{-1} a_{i-1}^c \\
...
Since the evolution operators $\Phi(0, 0; \lambda)$ involve $\lambda$ but the projections we will be taking are for $\lambda = 0$, we will substitute
\begin{align*}
