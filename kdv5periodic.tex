...
\leq C \left( |\lambda|(e^{-\alpha_0 X^*}+ |\lambda|) |c| + |\lambda|^2 |d| \right).
\end{align*}
The other integral is similar. Combining these, we have the uniform bound for $L_3$
\begin{equation}\label{L3bound}
|L_3(\lambda)(b, c, d)| \leq C \left( e^{-\alpha X^*} |b| + |\lambda|(e^{-\alpha_0 X^*}+ |\lambda|) |c| + |\lambda|^2 |d| \right).
\end{equation}
Define
\[
...
|\tilde{A}_2(\lambda)_i(b, c, d) &\leq C |\lambda| \left( e^{-\alpha_0 X_i} |b| + (e^{-\alpha X_i} + |\lambda|^2) |c_i| +|\lambda|^2 |d| \right) \label{tildeA2bound}
\end{align}
...
\end{align*}
Handling the other terms in $L_3(\lambda)_i(b, c, d)$ similarly, we obtain the bound
\begin{equation}\label{W0L3bound}
|\langle W_0, L_3(\lambda)_i(b, c, d) \rangle| \leq C |\lambda| \left( e^{-\alpha X_i} |b| + |\lambda|(e^{-\alpha_0 X^*}+ |\lambda|) |c| + |\lambda|^2 |d| \right)
\end{equation}
