...
There exists $X^* > 0$ such that for $|X_i| \geq X^*$, $i = 0, \dots, n-1$, there are unique solutions of the form \cref{Upiecewise} to equations \eqref{exsystem1}, \eqref{exsystem2}, and \eqref{exsystem3} which are continuous except for $n$ jumps in the direction of $\Psi(0)$.
