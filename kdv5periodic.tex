...
\end{tabular}
\end{center}
\caption{Log of absolute error vs. $\log m$ for the first 15 essential spectrum eigenvalues with least squares linear regression line for periodic single pulse (left panel) and second periodic double pulse (right panel). Slopes of regression lines -3.02 (left) and -3.05 (right). $N = 1024$ grid points, $p = -1$, $c = 10$, $X = 200$.}
