...
\begin{align}
\lambda_* &= \sqrt{ \frac{-2a - R_1 }{M} } + \mathcal{O}(r) = \sqrt{ \frac{-2a}{M} } + \mathcal{O}(r) \label{deflambdastar} \\
X_* &= c \left( \frac{\pi i}{\lambda_*} - \frac{M \tilde{M} + M_c^2 }{M}\right) \label{defXstar},
\end{align}
and define $T_0 > 0$ by 
\begin{align}\label{defT0}
T_0 = \frac{M_c^2 }{2 \pi M^2 c } |\lambda_*|^5 X_0^2
\end{align}
...
X = X_* \pm \Delta X, \quad \Delta X = \frac{2 c \pi}{\lambda_*^2}\sqrt{T_0} + \mathcal{O}(s^2)
\end{equation}
...
\begin{align*}
\lambda = \lambda_* - s i \pm \sqrt{ T_0 -  s^2}, \quad T_0 = -\frac{M_c^2}{2 \pi M^2 c } \lambda_*^5 X_0^2,
\end{align*}
