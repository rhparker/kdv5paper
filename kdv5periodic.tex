...
\begin{aligned}
(W_i^-)'(x) &= A(Q_i^-(x); \lambda) W_i^-(x) + c_{i-1} e^{\nu(\lambda)X_{i-1}}(G_i^-(x; \lambda) - \lambda k_i^-(\lambda) B Q'(x)) + d_i \lambda^2 \tilde{H}_i^-(x) \\
(W_i^+)'(x) &= A(Q_i^+(x); \lambda) W_i^+(x) + c_i e^{-\nu(\lambda)X_i }(G_i^+(x; 
\lambda) - \lambda k_i^+(\lambda) B Q'(x)) + d_i \lambda^2 \tilde{H}_i^+(x) \\
...
G_i^\pm(x; \lambda) &= k_i^\pm(\lambda)\left( A(Q_i^\pm(x)) - A(Q(x))\right)Q'(x)  \\
...
The third equation states that $W_i^\pm$ have no component in $\C Q'(0)$. The other terms in the ansatz do not appear by \cref{klambdaIP}. The fourth equation states that the jumps can only be in the directions of $\Psi^c(0)$ and $\Psi(0)$. The terms involving $Q'(0)$ in the ansatz cancel since $Q'(0) \perp \Psi^c(0)\oplus\Psi(0)$. A solution to \eqref{eigsystem} solves the \cref{eigsystem} if and only if the $n$ jumps conditions at $x = 0$ in the direction of $\C \Psi(0) \oplus \C \Psi^c(0)$ are satisfied, i.e.  
...
\begin{aligned}
(Z_i^-)'(x) &= A(\lambda) Z_i^-(x) + c_{i-1} e^{\nu(\lambda)X_{i-1}} P_i^-(x; \lambda)^{-1}(G_i^-(x; \lambda) - \lambda k_i^-(\lambda) B Q'(x)) + \lambda^2 d_i P_i^-(x; \lambda)^{-1} \tilde{H}_i^-(x) \\
(Z_i^+)'(x) &= A(\lambda) Z_i^+(x) + c_i e^{-\nu(\lambda)X_i} P_i^+(x; \lambda)^{-1}(G_i^+(x; \lambda) - \lambda k_i^+(\lambda) B Q'(x)) + \lambda^2 d_i P_i^+(x; \lambda)^{-1} \tilde{H}_i^+(x)
\end{aligned}
\end{equation}
