...
\end{equation}
from which it follows that the variational equation $V'(x) = DF(Q_1(x))V(x)$ has a unique bounded solution $Q_1'(x)$. We then have the following existence theorem. The proof is given in \cref{sec:transverseintproof}.
