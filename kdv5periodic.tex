...
- e^{\nu(\lambda)X_i}c_{i-1}\left( 1 + \frac{1}{2}\lambda \tilde{M} + \mathcal{O}\left( (e^{-\alpha_0 X^*} +|\lambda|)^2 \right) \right).
\end{align*}
...
\begin{align*}
\xi^c_i &= e^{-\nu(\lambda)X_i}c_i\left( 1 - \frac{1}{2}\lambda \tilde{M} + (e^{-\alpha_0 X^*} + |\lambda|)^2 \right) 
- e^{\nu(\lambda)X_i}c_{i-1}\left( 1 + \frac{1}{2}\lambda \tilde{M} + (e^{-\alpha_0 X^*} + |\lambda|)^2 \right) \\
...
\begin{align*}
\langle \Psi(0), &c_i e^{-\nu(\lambda)X_i}V_i^+(0; \lambda) - c_{i-1} e^{\nu(\lambda)X_i} V_i^-(0; \lambda) \rangle \\
&\qquad = -e^{-\nu(\lambda)X_i}c_i \left( \frac{1}{2}\lambda M_c + \mathcal{O}\left( (e^{-\alpha X^*} +|\lambda|)^2 \right)\right) - e^{\nu(\lambda)X_i}c_{i-1}\left( \frac{1}{2}\lambda M_c + \mathcal{O}\left( (e^{-\alpha X^*} +|\lambda|)^2 \right)\right) 
\end{align*}
