...
As a corollary, periodic single pulse solutions exist for sufficiently large $X_0$ since there are no jump conditions. These are periodic orbits which are close to the primary homoclinic orbit $Q(x)$.
